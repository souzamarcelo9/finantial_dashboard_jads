      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-300">Percentual de poupança</span>
        ...
        <div className={`p-4 rounded-xl border ${getNetWorthColor(kpiData.netWorth)}`}>
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-300">Mudança no patrimônio líquido</span>
          ...
          <div className="text-xs text-gray-400 mt-1">
            {formatCurrency(Math.abs(kpiData.netWorthPerMonth))}/mês{" "}
            {kpiData.netWorth >= 0 ? "↑" : "↓"}
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-300">Velocidade de gastos (30d)</span>
            <Calculator
              size={22}
          ...
          <div className="text-xs text-gray-400 mt-1">
            {kpiData.spendingVelocity > 100 ? "Acima" : "Abaixo"} média
          </div>
        </div>
        ...
        {kpiData.categoryConcentration && (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-300">Top Categorias</span>
            ...
            <div className="text-xs text-gray-400 mt-1">
              {(kpiData.categoryConcentration?.percentage ?? 0).toFixed(0)}% de gastos
              {(kpiData.categoryConcentration?.percentage ?? 0) >
                CATEGORY_CONCENTRATION_THRESHOLD && " (Alto)"}
            </div>
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-purple-900/30 p-4 rounded-lg">
          <div className="flex items-center justify-between">
            <span className="text-sm text-purple-300">Dinheiro transferido em</span>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            aria-label="Selecione o ano para os insights"
          >
          ...
          <select
            ...
            aria-label="Selecione o mês para os insights"
          >
    ...
    <div>
      ...
      <div className="bg-gray-800/40 border border-gray-700/30 rounded-2xl p-6 mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          />
          <SmallKPICard
            title="Valor Médio por Lançamento"
