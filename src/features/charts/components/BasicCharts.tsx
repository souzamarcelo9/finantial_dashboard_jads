...
export const IncomeVsExpenseChart = ({ data, chartRef }: ChartProps<DoughnutData>) => (
  <ChartCard title="Receita vs Despesa" chartRef={chartRef} fileName="income-vs-expense.png">
...
export const TopExpenseCategoriesChart = ({ data, chartRef }: ChartProps<BarData>) => (
  <ChartCard title="Principais Categorias de Despesa" chartRef={chartRef} fileName="top-expenses.png">
    <Bar ref={chartRef} data={data} options={commonChartOptions} />
  </ChartCard>
);

export const TopIncomeSourcesChart = ({ data, chartRef }: ChartProps<BarData>) => (
  <ChartCard title="Principais Fontes de Receita" chartRef={chartRef} fileName="top-income.png">
    <Bar ref={chartRef} data={data} options={commonChartOptions} />
  </ChartCard>
);

export const SpendingByAccountChart = ({ data, chartRef }: ChartProps<DoughnutData>) => (
  <ChartCard title="Gastos por Conta" chartRef={chartRef} fileName="spending-by-account.png">
    <Doughnut ref={chartRef} data={data} options={doughnutOptions} />
  </ChartCard>
);

export const MonthlyTrendsChart = ({ data, chartRef }: ChartProps<LineData>) => (
  <ChartCard title="Tendências Mensais" chartRef={chartRef} fileName="monthly-trends.png">
    <Line ref={chartRef} data={data} options={commonChartOptions} />
  </ChartCard>
);

export const SpendingByDayChart = ({ data, chartRef }: ChartProps<BarData>) => (
  <ChartCard title="Gastos por Dia da Semana" chartRef={chartRef} fileName="spending-by-day.png">
    <Bar ref={chartRef} data={data} options={commonChartOptions} />
  </ChartCard>
);

export const SubcategoryBreakdownChart = ({ data, chartRef }: SubcategoryBreakdownChartProps) => (
  <ChartCard title="Detalhamento por Subcategoria" chartRef={chartRef} fileName="subcategory-breakdown.png">
    <Bar ref={chartRef} data={data} options={commonChartOptions} />
  </ChartCard>
);
