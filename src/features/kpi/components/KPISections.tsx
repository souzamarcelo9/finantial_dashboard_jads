    ...
    <>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
        <SmallKPICard
          ...
          isCount={true}
        />
        <SmallKPICard title="Maior Despesa" value={highestExpense} icon={<Target size={22} />} />
        <SmallKPICard title="Despesa Média" value={averageExpense} icon={<Sigma size={22} />} />
      </div>
