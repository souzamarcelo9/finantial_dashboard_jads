...
export const RecurringPayments = ({ filteredData }: RecurringPaymentsProps) => {
  ...
  const getDaysUntil = (nextDate?: string | Date) => {
    ...
    if (days < 0) {
      return { text: "Atrasado", color: "text-red-400" };
    }
    if (days === 0) {
      return { text: "Hoje", color: "text-orange-400" };
    }
    if (days === 1) {
      return { text: "Amanhã", color: "text-yellow-400" };
    }
    if (days <= 7) {
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white font-bold">
                        R$
                        {(payment.averageAmount ?? 0).toLocaleString("pt-BR", {
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-purple-400 font-medium text-sm">
                        R$
                        {(payment.monthlyEquivalent ?? 0).toLocaleString("pt-BR", {
                          maximumFractionDigits: 0,
                        })}
                        /mo
                      </span>
            ...
            {inactivePayments.map((payment, index) => (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-500 text-sm">Última vez visto</span>
