...
export const NeedsWantsSavings = ({ transactions }: NeedsWantsSavingsProps) => {
  ...
  const saveAllocationChanges = () => {
    ...
    if (Math.abs(total - 100) > 0.1) {
      alert("A alocação total deve somar 100%");
      return;
    }
  ...
  const categories: Array<{
    ...
    { key: "needs", label: "Necessidades", icon: "🏠", color: NWS_COLORS.needs },
    { key: "wants", label: "Desejos", icon: "🎉", color: NWS_COLORS.wants },
    { key: "savings", label: "Poupança", icon: "💰", color: NWS_COLORS.savings },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h3 className="text-2xl font-bold text-white">Detalhamento do Orçamento 50/30/20</h3>
          <p className="text-gray-400 mt-1">Acompanhe seus gastos entre Necessidades, Desejos e Poupança</p>
        </div>
      ...
      {/* Visual Breakdown */}
      <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
        <h4 className="text-lg font-semibold text-white mb-4">Distribuição de Gastos</h4>
      ...
      {/* Category Details */}
      <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
        <h4 className="text-lg font-semibold text-white mb-4">Detalhamento por Categoria</h4>
              ...
              <div key={key}>
                ...
                <div className="space-y-2">
                  {sortedCategories.length > 0 ? (
                    ...
                    <p className="text-sm text-gray-500">Sem lançamentos</p>
                  )}
