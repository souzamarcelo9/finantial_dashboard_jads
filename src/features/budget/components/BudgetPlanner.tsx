  ...
  return (
    <div className="space-y-6">
      ...
      {totalBudget > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-gray-800/50 rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-white mt-1">R${totalBudget.toLocaleString()}</p>
          </div>
          <div className="bg-gray-800/50 rounded-xl p-4">
            <p className="text-gray-400 text-sm">Total Gasto</p>
            <p className="text-2xl font-bold text-white mt-1">R${totalActual.toLocaleString()}</p>
          </div>
          <div
          ...
          <div className="bg-gray-800/50 rounded-xl p-4">
            <p className="text-gray-400 text-sm">Uso Geral</p>
      ...
      <div className="bg-gray-800/50 rounded-xl p-6">
        <h3 className="text-lg font-semibold text-white mb-4">Orçamentos por Categoria</h3>
                  ...
                  <>
                    ...
                    <div className="flex justify-between text-xs">
                      <span className="text-gray-500">
                        3-Month Avg: R${Math.round(average).toLocaleString()}
                      </span>
                      <span className={comp.remaining >= 0 ? "text-green-400" : "text-red-400"}>
                        {comp.remaining >= 0 ? "Restante" : "Acima de"}: R$
