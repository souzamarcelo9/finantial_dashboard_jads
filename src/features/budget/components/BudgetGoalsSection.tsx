...
export const BudgetGoalsSection = ({
  ...
  const tabs = [
    ...
    { id: "budgets", label: "Orçamentos por Categoria", icon: "💰" },
    { id: "nws", label: "Necessidades/Desejos/Poupança", icon: "🎯" },
    { id: "timeline", label: "Mensal e Anual", icon: "📈" },
    { id: "calendar", label: "Calendário de Gastos", icon: "📅" },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-white mb-2">🎯 Orçamento e Planejamento</h1>
        <p className="text-gray-400">
          Acompanhe sua saúde financeira e planeje seus gastos com o detalhamento Necessidades/Desejos/Poupança
        </p>
      </div>
