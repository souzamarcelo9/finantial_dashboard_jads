 ...
 * @param {string} value - The currency string to parse (e.g., "R$1,234.56")
...
export const parseCurrency = (value) => {
  ...
  return Number.parseFloat(value.replaceAll("R$", "").replaceAll(",", "")) || 0;
};
 ...
 * @returns {string} Ano-calendário no formato "2026"
 * @example
 * getFinancialYear(new Date('2026-04-15')) // returns "2026"
 * getFinancialYear(new Date('2026-01-15')) // returns "2026"
 */
export const getFinancialYear = (date) => {
  ...
  // No Brasil o ano-calendário do IRPF é Jan-Dez (igual ao ano civil)
