...
describe("Investment Analytics - Business Logic", () => {
  ...
  describe("formatCurrency", () => {
    it("should format currency with Brazilian locale by default", () => {
      const result = formatCurrency(100000);
      expect(result).toMatch(/R\$/); // Should contain Real symbol
      expect(result).toMatch(/100\.000/); // Should have pt-BR thousand separator
    });
