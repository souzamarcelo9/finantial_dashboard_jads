...
export const calculateReimbursementMetrics = (transactions: Transaction[]) => {
  ...
  if (totalReimbursements > 0) {
    insights.push({
      ...
      message: `R$${totalReimbursements.toLocaleString()} received from ${reimbTransactions.length} reimbursements`,
      priority: "positive",
    });
  }
  ...
  if (averageReimbursement > 0) {
    insights.push({
      ...
      message: `R$${averageReimbursement.toLocaleString()} per reimbursement`,
      priority: "neutral",
    });
  }
  ...
  if (recentReimbursements.length > 0) {
    ...
    insights.push({
      ...
      message: `R$${recentTotal.toLocaleString()} reimbursed in last 30 days`,
      priority: "positive",
    });
  }
